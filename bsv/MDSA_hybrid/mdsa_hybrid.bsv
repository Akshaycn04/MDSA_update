...
module mk_mdsa_hybrid(Ifc_mdsa_hybrid);
    ...
    Vector#(8, Ifc_sorting_network) hybrid_sorters <- replicateM(mk_sorting_network());

    /*------------------ PHASE 1: Column Sorting (All Normal = Descending) ----------------*/
    rule rl_phase1_input(rg_mdsa_fsm == STAGE_1_IN);
        $display("[%0d] [MDSA] PHASE 1: Column Sorting (All Normal/Descending)", $time);
    ...
    rule rl_phase2_input(rg_mdsa_fsm == STAGE_2_IN);
        $display("[%0d] [MDSA] PHASE 2: Row Sorting (Even=Reverse, Odd=Normal)", $time);
    ...
    rule rl_phase3_input(rg_mdsa_fsm == STAGE_3_IN);
        $display("[%0d] [MDSA] PHASE 3: Column Sorting (All Normal/Descending)", $time);
    ...
    rule rl_phase4_input(rg_mdsa_fsm == STAGE_4_IN);
        $display("[%0d] [MDSA] PHASE 4: Row Sorting (Odd=Reverse, Even=Normal)", $time);
    ...
    rule rl_phase5_input(rg_mdsa_fsm == STAGE_5_IN);
        $display("[%0d] [MDSA] PHASE 5: Column Sorting (All Normal/Descending)", $time);
    ...
    rule rl_phase6_input(rg_mdsa_fsm == STAGE_6_IN);
        $display("[%0d] [MDSA] PHASE 6: Row Sorting (All Normal/Descending) - Final", $time);
